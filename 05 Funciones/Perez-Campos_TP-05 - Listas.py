...
print(numeros)
"""
#Este programa crea una lista "numeros" con 5 elementos de tipo int, luego elimina el valor máximo en la lista y finalmente la imprime por pantalla
